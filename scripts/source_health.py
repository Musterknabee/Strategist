...
HIGH_GRAVITY_ROOTS = (
    ...
    "strategy_validator/cli/thesis_mutation_batch_loop.py",
    "strategy_validator/contracts/oracle_mutation_proposal.py",
    "strategy_validator/core/path_guards.py",
    "strategy_validator/core/provider_url_policy.py",
    "strategy_validator/research/oracle_mutation_proposal.py",
    "strategy_validator/research/strategy_batch_evaluators_registry.py",
    "strategy_validator/research/strategy_holdout_gate.py",
    "strategy_validator/research/thesis_mutation_batch_loop.py",
    ...
    "scripts/purge_repo_transients.py",
    ...
    "tests/constitutional/test_cli_help_smoke_encoding.py",
