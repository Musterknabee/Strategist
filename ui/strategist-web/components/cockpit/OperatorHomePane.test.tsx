...
describe("OperatorHomePane", () => {
  ...
  it("renders disclaimer", () => { render(<OperatorHomePane summary={summary} onShowAdvanced={vi.fn()} onOpenDetail={vi.fn()} />); expect(screen.getByText(/Paper only - no live trading/i)).toBeTruthy(); });
});
