...
def test_attestation_exposes_trust_and_control_plane_summaries() -> None:
    attestation = build_oracle_morning_attestation(_payload())
    assert attestation.trust_plane_summary_line
    assert attestation.control_plane_summary_line
    markdown = render_oracle_morning_attestation_markdown(attestation)
    assert attestation.trust_plane_summary_line in markdown
    assert attestation.control_plane_summary_line in markdown
