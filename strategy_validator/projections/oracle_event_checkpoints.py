...
def build_oracle_event_checkpoint_projection_registry(
    *,
...
def emit_oracle_event_checkpoint_projection_registry(
    *,
    ...
    registry = build_oracle_event_checkpoint_projection_registry(
        projection_label=projection_label,
        projection_version=projection_version,
        lane_path=lane_path,
        output_paths=output_paths,
