...
from strategy_validator.contracts.oracle_operator_reports import OracleBriefingPackReport, OracleIncidentPackReport, OracleStatusPackReport
...
def assemble_oracle_status_pack(request: OracleStatusPackAssemblyRequest | None = None, **kwargs) -> OracleStatusPackReport:
    ...
    from strategy_validator.validator.oracle_diagnostics_status_pack_builders import _build_oracle_status_pack_impl
...
def assemble_oracle_incident_pack(request: OracleIncidentPackAssemblyRequest | None = None, **kwargs) -> OracleIncidentPackReport:
    ...
    from strategy_validator.validator.oracle_diagnostics_incident_pack import _build_oracle_incident_pack_impl
