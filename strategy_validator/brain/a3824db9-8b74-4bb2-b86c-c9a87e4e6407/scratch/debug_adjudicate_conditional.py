...
exp = ExperimentManifest(
    experiment_id="EXP-CON", strategy_name="s", version="1", proposer_id="p", evidence_bundle=_passing_bundle()
)
# Clear DSR/PBO to trigger conditional
exp.evidence_bundle.dsr_estimate = None
exp.evidence_bundle.pbo_estimate = None

evidence = [_ev("EXP-CON", pit_integrity_ok=True, benchmark_passed=True, benchmark_delta=0.02, benchmark_id="SPY", benchmark_version="bench-v1")]
