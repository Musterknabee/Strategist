...
exp = ExperimentManifest(
    experiment_id="EXP-PIT-FAIL", strategy_name="s", version="1", proposer_id="p", evidence_bundle=_passing_bundle()
)
# Evidence with PIT failure and MISSING benchmark info
evidence = [_ev("EXP-PIT-FAIL", pit_integrity_ok=False)]
