"""Shared helpers for semantic validator handoff clearance release receipt board."""
...
_SCHEMA_VERSION = "ui_semantic_validator_handoff_clearance_release_receipt_board/v1"
_LIMIT_MAX = 1000
_STATUS_RANK = {
    "CLEARANCE_RELEASE_RECEIPT_BLOCKED": 0,
    "CLEARANCE_RELEASE_RECEIPT_WAITING_EXTERNAL_ARTIFACT": 1,
    "CLEARANCE_RELEASE_RECEIPT_WAITING_ACCEPTANCE": 2,
    "CLEARANCE_RELEASE_RECEIPT_WAITING_CUSTODY_REVIEW": 3,
    "CLEARANCE_RELEASE_RECEIPT_INVESTIGATION_REQUIRED": 4,
    "CLEARANCE_RELEASE_RECEIPT_READY_FOR_HUMAN_RECEIPT_OBSERVATION": 5,
}
_READINESS_RANK = {
    "FAIL_CLOSED": 0,
    "WAITING": 1,
    "HUMAN_RECEIPT_READY_OBSERVATION": 2,
}
...
def _authority() -> dict[str, Any]:
    return {
        ...
        "authority_boundary": "read_plane_only_clearance_release_receipt_visibility_no_receipt_write_no_custody_write_no_transfer_no_release_no_approval_no_execute",
    }
