"""Shared helpers for the semantic validator handoff clearance action register read-plane."""
...
_SCHEMA_VERSION = "ui_semantic_validator_handoff_clearance_action_register/v1"
_LIMIT_MAX = 1000
_ACTION_STATE_RANK = {
    "BLOCKED_ACTION": 0,
    ...
    "REFRESH_REQUIRED": 3,
    "INVESTIGATION_REQUIRED": 4,
    "READY_REVIEW_CANDIDATE": 5,
}
_ACTION_TYPE_RANK = {
    "TRIAGE_CLEARANCE_BLOCKER": 0,
    "COLLECT_EXTERNAL_ARTIFACT": 1,
    "PERFORM_OPERATOR_REVIEW": 2,
    "REFRESH_UPSTREAM_EVIDENCE": 3,
    "INVESTIGATE_UNKNOWN_STATE": 4,
    "REVIEW_READY_COVERAGE": 5,
}
...
def _authority() -> dict[str, Any]:
    return {
        ...
        "action_acknowledgment_allowed": False,
        ...
        "authority_boundary": "read_plane_only_clearance_action_register_visibility_no_ack_no_execute_no_assert_no_attest_no_override_no_approval_no_signoff_no_write_no_submit",
    }
