"""Shared helpers for the clearance evidence matrix read-plane."""
...
_SCHEMA_VERSION = "ui_semantic_validator_handoff_clearance_evidence_matrix/v1"
_LIMIT_MAX = 1000
_STATE_RANK = {"BLOCKING_EVIDENCE_GAP": 0, "WAITING_EXTERNAL_ARTIFACT": 1, "ATTENTION_REQUIRED": 2, "VERIFIED_OBSERVATION": 3, "UNKNOWN": 9}
...
def _authority() -> dict[str, Any]:
    return {
        ...
        "authority_boundary": "read_plane_only_clearance_evidence_matrix_visibility_no_attest_no_override_no_ack_no_approval_no_signoff_no_write_no_submit_no_execute",
    }
