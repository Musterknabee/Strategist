"""Shared helpers for the semantic validator handoff clearance checklist read-plane."""
...
_SCHEMA_VERSION = "ui_semantic_validator_handoff_clearance_checklist/v1"
_LIMIT_MAX = 1000
_CHECK_STATE_RANK = {
    "BLOCKED": 0,
...
def _authority() -> dict[str, Any]:
    return {
        ...
        "authority_boundary": "read_plane_only_clearance_checklist_visibility_no_ack_no_override_no_approval_no_signoff_no_write_no_submit_no_execute",
    }
