"""Shared helpers for semantic validator handoff clearance gate read-plane."""
...
_SCHEMA_VERSION = "ui_semantic_validator_handoff_clearance_gate/v1"
_LIMIT_MAX = 1000
_STATUS_RANK = {
    "BLOCKED_BY_RESOLUTION_STEP": 0,
...
def _authority() -> dict[str, Any]:
    return {
        ...
        "authority_boundary": "read_plane_only_clearance_gate_visibility_no_approval_no_signoff_no_ack_no_write_no_submit_no_execute",
    }
