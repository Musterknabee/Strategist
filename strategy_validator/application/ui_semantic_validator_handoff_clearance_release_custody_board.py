"""Read-only clearance release custody board for semantic validator handoff closure.

This module is intentionally kept as a compatibility facade. The clearance
release-custody implementation is decomposed into focused subphase modules for
shared helpers, custody synthesis/filtering, and public payload assembly.
"""
...
from strategy_validator.application.ui_semantic_validator_handoff_clearance_release_custody_board_payload import (
