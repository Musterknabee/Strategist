"""Shared helpers for semantic validator handoff exception queue read-plane."""
...
_SCHEMA_VERSION = "ui_semantic_validator_handoff_exceptions/v1"
_LIMIT_MAX = 1000
...
def _authority() -> dict[str, Any]:
    return {
        ...
        "authority_boundary": "read_plane_only_exception_visibility_no_writes_no_submission_no_execution",
    }
