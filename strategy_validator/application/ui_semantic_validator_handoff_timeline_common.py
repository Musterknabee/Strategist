"""Shared helpers for semantic validator handoff timeline read-plane payloads."""
...
_SCHEMA_VERSION = "ui_semantic_validator_handoff_timeline/v1"
_LIMIT_MAX = 1000
_STAGE_ORDER: dict[str, int] = {"decision": 1, "signoff": 2, "custody": 3, "archive": 4, "closure": 5}
...
def _authority() -> dict[str, Any]:
    return {
        ...
        "authority_boundary": "read_plane_only_timeline_visibility_no_writes_no_submission_no_execution",
    }
