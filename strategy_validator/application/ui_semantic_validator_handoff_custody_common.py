"""Shared helpers for semantic validator-handoff custody read planes."""
...
_SCHEMA_VERSION = "ui_semantic_validator_handoff_custody/v1"
_CUSTODY_SEAL_SCHEMA_VERSION = "semantic_validator_handoff_custody_seal/v1"
_RECORDED_SIGNOFF_STATUS = "OPERATOR_SIGNOFF_RECORDED"
_RECORDED_STATUS = "CUSTODY_SEAL_RECORDED"
_READY_STATUS = "READY_FOR_EXTERNAL_CUSTODY_SEAL"
_INVALID_STATUS = "CUSTODY_SEAL_INVALID"
_DIGEST_MISMATCH_STATUS = "CUSTODY_SEAL_DIGEST_MISMATCH"
_BLOCKED_STATUS = "BLOCKED_SIGNOFF_NOT_RECORDED"
...
def _seal_value(raw: dict[str, Any], *names: str) -> str:
    for name in names:
