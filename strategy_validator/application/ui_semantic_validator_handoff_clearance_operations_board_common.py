"""Shared helpers for the semantic validator handoff clearance operations board read-plane."""
...
_SCHEMA_VERSION = "ui_semantic_validator_handoff_clearance_operations_board/v1"
_LIMIT_MAX = 1000
_OPERATION_STATE_RANK = {
    "BLOCKED_CLEARANCE_OPERATION": 0,
    "EXTERNAL_ARTIFACT_OPERATION": 1,
    "OPERATOR_REVIEW_OPERATION": 2,
    "NO_CLEARANCE_EVIDENCE": 3,
    "UNKNOWN_CLEARANCE_OPERATION": 4,
    "COVERAGE_OBSERVED_READY": 5,
}
_ACTION_GROUP_RANK = {
    "TRIAGE_BLOCKERS": 0,
    "COLLECT_EXTERNAL_ARTIFACTS": 1,
    "OPERATOR_REVIEW": 2,
    "REFRESH_UPSTREAM_EVIDENCE": 3,
    "INVESTIGATE_UNKNOWN": 4,
    "READINESS_REVIEW": 5,
}
...
def _authority() -> dict[str, Any]:
    return {
        ...
        "authority_boundary": "read_plane_only_clearance_operations_board_visibility_no_ack_no_assert_no_attest_no_override_no_approval_no_signoff_no_write_no_submit_no_execute",
    }
