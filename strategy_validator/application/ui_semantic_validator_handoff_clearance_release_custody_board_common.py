"""Shared helpers for semantic validator handoff clearance release custody board."""
...
_SCHEMA_VERSION = "ui_semantic_validator_handoff_clearance_release_custody_board/v1"
_LIMIT_MAX = 1000
_STATUS_RANK = {
    "CLEARANCE_RELEASE_CUSTODY_BLOCKED": 0,
    "CLEARANCE_RELEASE_CUSTODY_WAITING_EXTERNAL_ARTIFACT": 1,
    "CLEARANCE_RELEASE_CUSTODY_WAITING_ACCEPTANCE": 2,
    "CLEARANCE_RELEASE_CUSTODY_WAITING_HANDOFF_REVIEW": 3,
    "CLEARANCE_RELEASE_CUSTODY_INVESTIGATION_REQUIRED": 4,
    "CLEARANCE_RELEASE_CUSTODY_READY_FOR_HUMAN_CUSTODY_OBSERVATION": 5,
}
_READINESS_RANK = {
    "FAIL_CLOSED": 0,
    "WAITING": 1,
    "HUMAN_CUSTODY_READY_OBSERVATION": 2,
}
...
def _authority() -> dict[str, Any]:
    return {
        ...
        "authority_boundary": "read_plane_only_clearance_release_custody_visibility_no_custody_write_no_transfer_no_handoff_write_no_release_no_signoff_no_approval_no_decision_no_submit_no_execute",
    }
