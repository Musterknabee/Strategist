"""Shared helpers for semantic validator handoff signoff read-plane."""
...
_SCHEMA_VERSION = "ui_semantic_validator_handoff_signoff/v1"
_SIGNOFF_SCHEMA_VERSION = "semantic_validator_handoff_operator_signoff/v1"
_READY_DECISION_STATUS = "READY_FOR_OPERATOR_DECISION_DRAFT"
_RECORDED_STATUS = "OPERATOR_SIGNOFF_RECORDED"
_AWAITING_STATUS = "AWAITING_OPERATOR_SIGNOFF"
_INVALID_STATUS = "SIGNOFF_INVALID"
_DIGEST_MISMATCH_STATUS = "SIGNOFF_DIGEST_MISMATCH"
_BLOCKED_STATUS = "BLOCKED_DECISION_NOT_SIGNABLE"
...
def _packet_digest(decision: dict[str, Any]) -> str:
...
def _signoff_value(raw: dict[str, Any], *names: str) -> str:
    for name in names:
