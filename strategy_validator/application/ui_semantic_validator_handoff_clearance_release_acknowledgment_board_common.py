"""Shared helpers for semantic validator handoff clearance release acknowledgment board."""
...
_SCHEMA_VERSION = "ui_semantic_validator_handoff_clearance_release_acknowledgment_board/v1"
_STATUS_RANK = {
    "CLEARANCE_RELEASE_ACKNOWLEDGMENT_BLOCKED": 0,
    "CLEARANCE_RELEASE_ACKNOWLEDGMENT_WAITING_EXTERNAL_ARTIFACT": 1,
    "CLEARANCE_RELEASE_ACKNOWLEDGMENT_WAITING_ACCEPTANCE": 2,
    "CLEARANCE_RELEASE_ACKNOWLEDGMENT_WAITING_RECEIPT_REVIEW": 3,
    "CLEARANCE_RELEASE_ACKNOWLEDGMENT_INVESTIGATION_REQUIRED": 4,
    "CLEARANCE_RELEASE_ACKNOWLEDGMENT_READY_FOR_HUMAN_ACKNOWLEDGMENT_OBSERVATION": 5,
}
_READINESS_RANK = {"FAIL_CLOSED": 0, "WAITING": 1, "HUMAN_ACKNOWLEDGMENT_READY_OBSERVATION": 2}
_LIMIT_MAX = 1000
...
def _authority() -> dict[str, Any]:
    return {
        ...
        "authority_boundary": "read_plane_only_clearance_release_acknowledgment_visibility_no_acknowledgment_write_no_receipt_write_no_custody_transfer_no_release_no_approval_no_execute",
    }
