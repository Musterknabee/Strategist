...
OPERATOR_COMMAND_REGISTRY: Mapping[str, Mapping[str, str]] = {
    ...
    "strategy-validator-researcher-certify": {
        "purpose": "Certify paper-only Researcher phase artifacts and fail closed on missing governance evidence",
        "mode": "READ_ONLY",
        "requires_token": "no",
        "writes_artifacts": "no",
        "safety_notes": "Certification checks only; no live broker, capital, or order authority.",
    },
...
OPERATOR_COMMAND_EXEMPTIONS: tuple[str, ...] = (
    ...
    "strategy-validator-researcher-cycle",
